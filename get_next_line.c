...
/*   Updated: 2021/05/23 14:29:27 by twagner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

int	ft_fill_buffer_until_n(char **bufline, int fd)
{
	char	*buf;
	int		linelen;
	int		ret;
...
int	ft_update_bufline(char **bufline)
{
	char	*tofree;
	int		nl_index;
...
int	ft_return_line(char **line, char **bufline, int	status)
{
	int		nl_index;
...
int	ft_init_bufline(char **bufline)
{
	if (!*bufline)
	{
